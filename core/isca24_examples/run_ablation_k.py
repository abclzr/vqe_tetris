...
if __name__ == '__main__':
    ...
    for ablation_k in [13, 16, 19, 22]:#[1, 4, 7, 10]:
        ...
        for i in range(0,k):
            ...
            metrics = Tetris_lookahead_Mahattan(parr, use_bridge=False, swap_coefficient=3, k=ablation_k)
            metrics_list.append((moles[i], metrics))

        pickle_dump(metrics_list, f'runs_final/ablation/ithaca_k_{ablation_k}.pickle')
