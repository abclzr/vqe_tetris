...
class CompileQAOAQiskit:
    ...
    qc_json = None, config_json = None, out_circuit_file_name = 'QAOA.qasm'):
        ...
        self.initial_layout = list(range(int(20)))
        self.circuit = None
    ...
    def _approximate_equivalence(self, ckt = None):
        ...
        if abs_diff/1000000 < 0.01*int(20):
            return True
        return False
    ...
    def _qasm_note(self, ckt = None, pol = None):
        ...
        if ckt:
            ...
            print('({}) Depth: {}, CNOT: {}, single: {}, total: {}, ESP: {}'.format(pol, ckt.depth(),
            ckt.count_ops()[self.native_2q[0]], sum(ckt.count_ops().values())-ckt.count_ops()[self.native_2q[0]], sum(ckt.count_ops().values()), math.exp(-self.cost)))
