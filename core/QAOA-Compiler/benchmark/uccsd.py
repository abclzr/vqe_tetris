...
def get_qubit_op(atom_config, freeze_core=False, two_qubit_reduction=False, remove_list=None, qubit_mapping='jordan_wigner'):
    driver = PySCFDriver(atom=atom_config, unit=UnitsType.ANGSTROM, charge=0, spin=0, basis='sto3g')
    molecule = driver.run()
...
if __name__ == '__main1__':
    ...
    import time
    t0 = time.time()
    parr = gene_uccsd_oplist(30, 22, qubit_mapping='jordan_wigner')
    count(parr)
